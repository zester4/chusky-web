...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return <div className="min-h-screen text-foreground" style={{ backgroundColor: branding?.backgroundColor || "#f7f7f4" }}>
