...
export const chuskyApi = {
  ...
  meetings: {
    ...
    join: (input: { meetingUrl: string; title?: string; joinAt?: string; interactionMode?: Meeting["interactionMode"]; analyzeScreenShare?: boolean; transcriptRetentionDays?: 1 | 7 | 30; roomId?: string; languageMode?: Meeting["languageMode"]; languageHints?: string[]; keyterms?: string[] }) => request<Meeting>("/meetings", { method: "POST", headers: { "Idempotency-Key": idempotency() }, body: JSON.stringify(input) }),
